...
export const userReducer = (state: initialStateType = initialState, action: TsarPropsType): initialStateType => {
    switch (action.type) {
        ...
        case TOGGLE_IS_FOLLOWING_PROGRESS:
            return {...state, followingInProgress:action.followingInProgress?[...state.followingInProgress,action.userId] : state.followingInProgress.filter(id=>id!==action.userId)}
